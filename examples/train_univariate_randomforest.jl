...
function cli_args(args)
    ...
    examples:\n
    \n
    \ua0\ua0julia $(basename(Base.source_path())) -c examples/example_taxonomic_profile.csv 6:554 4 test_output
    \n
    \ua0\ua0julia $(basename(Base.source_path())) -r examples/example_taxonomic_profile.csv 6:554 4 test_output
    \n
