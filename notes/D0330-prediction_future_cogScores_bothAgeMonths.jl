...
#X = prediction_df[:, [ 2, collect(9:end)...]] # Taxonmic profile + original ageMonths
#X = prediction_df[:, [ 4, collect(9:end)...]] # Taxonmic profile + future ageMonths
X = prediction_df[:, [ 2, 4, collect(9:end)...]] # Taxonmic profile + original ageMonths + future ageMonths
y = prediction_df[:, 8]
