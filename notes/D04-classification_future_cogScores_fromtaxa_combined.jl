#####
# Notebook D04 - Classification of binary current CogScores above/below average from current taxonomic data
#####
...
function train_randomforest_future_classifier(df; n_trials = 2, max_stool_ageMonths = 12.0, max_future_ageMonths=24.0, split_proportion=0.75, train_rng=Random.GLOBAL_RNG)
