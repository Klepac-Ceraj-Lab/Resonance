#####
# Notebook D03 - Classification of binary future CogScores above/below 50th percentile
#####
...
classification_futureCogScores_00to12mo_onlydemo = train_randomforest(
...
report_merits(classification_futureCogScores_00to12mo_onlydemo)

JLD2.@save "models/classification_futureCogScores_00to12mo_onlydemo.jld" classification_futureCogScores_00to12mo_onlydemo

## 2. Only taxonomic profiles

classification_futureCogScores_00to12mo_onlytaxa = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_futureCogScores_00to12mo_onlytaxa)

JLD2.@save "models/classification_futureCogScores_00to12mo_onlytaxa.jld" classification_futureCogScores_00to12mo_onlytaxa

## 3. SES + taxonomic profiles

classification_futureCogScores_00to12mo_demoplustaxa = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_futureCogScores_00to12mo_demoplustaxa)

JLD2.@save "models/classification_futureCogScores_00to12mo_demoplustaxa.jld" classification_futureCogScores_00to12mo_demoplustaxa

## 4. Only functional profiles

classification_futureCogScores_00to12mo_onlyecs = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_futureCogScores_00to12mo_onlyecs)

JLD2.@save "models/classification_futureCogScores_00to12mo_onlyecs.jld" classification_futureCogScores_00to12mo_onlyecs

## 5. SES + taxonomic profiles

classification_futureCogScores_00to12mo_demoplusecs = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_futureCogScores_00to12mo_demoplusecs)

JLD2.@save "models/classification_futureCogScores_00to12mo_demoplusecs.jld" classification_futureCogScores_00to12mo_demoplusecs