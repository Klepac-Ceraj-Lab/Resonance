#####
# Notebook D11 - Classification of binary current CogScores above/below average from current functional data
#####
...
## 0 to 6 months
classification_currentCogScores_00to06_fromfunctions_results = train_randomforest(
    Resonance.Classification(),
    "classification_currentCogScores_00to06_fromfunctions_results",
...
## 6 to 12 months
classification_currentCogScores_06to12_fromfunctions_results = train_randomforest(
    Resonance.Classification(),
    "classification_currentCogScores_06to12_fromfunctions_results",
    cogscore_functions_df,
...
## 12 to 18 months
classification_currentCogScores_12to18_fromfunctions_results = train_randomforest(
    Resonance.Classification(),
    "classification_currentCogScores_12to18_fromfunctions_results",
    cogscore_functions_df,
...
## 18 to 24 months
classification_currentCogScores_18to24_fromfunctions_results = train_randomforest(
    Resonance.Classification(),
    "classification_currentCogScores_18to24_fromfunctions_results",
    cogscore_functions_df,
