...
X = prediction_df_12_18[:, 6:end]
y = prediction_df_12_18[:, 4]
...
ax = Axis(train_set_plot[1, 1],
    title = "Comparison of predicted vs ground truth *Current cogScore* for ages 12-18 months, *TRAIN* set",
    xlabel = "Ground Truth",
    ylabel = "Prediction"
)
...
title = "Comparison of predicted vs ground truth *Current cogScore* for ages 12-18 months, *TEST* set",
    xlabel = "Ground Truth",
    ylabel = "Prediction"
)
...
ax = Axis(all_set_plot[1, 1],
    title = "Comparison of predicted vs ground truth *Current cogScore* for ages 12-18 months,\n*FULL SAMPLE SET*",
    xlabel = "Ground Truth",
    ylabel = "Prediction"
)
