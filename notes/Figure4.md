...
#### Plot 3.1 - Confusion Matrix / Accuracies for 00 to 06 months
...
# Plot
tbl1_1 = confmatrix2barplot(classification_currentCogScores_00to06_fromfunctions_results)
barplot!(ax1_1, tbl1_1.x, tbl1_1.value,
        stack = tbl1_1.grp,
        color = confplot_colors[tbl1_1.color])
```

#### Plot 3.2 - Confusion Matrix / Accuracies for 00 to 06 months
```julia
# Axis
ax1_2 = Axis(
    figure[5,2];
...
# Plot
tbl1_2 = confmatrix2barplot(classification_currentCogScores_06to12_fromfunctions_results)
barplot!(ax1_2, tbl1_2.x, tbl1_2.value,
        stack = tbl1_2.grp,
        color = confplot_colors[tbl1_2.color])
```

#### Plot 3.3 - Confusion Matrix / Accuracies for 00 to 06 months
```julia
# Axis
ax1_3 = Axis(
    figure[5,3];
...
# Plot
tbl1_3 = confmatrix2barplot(classification_currentCogScores_12to18_fromfunctions_results)
barplot!(ax1_3, tbl1_3.x, tbl1_3.value,
        stack = tbl1_3.grp,
        color = confplot_colors[tbl1_3.color])
```

#### Plot 3.4 - Confusion Matrix / Accuracies for 00 to 06 months
```julia
# Axis
ax1_4 = Axis(
    figure[5,4];
...
# Plot
tbl1_4 = confmatrix2barplot(classification_currentCogScores_18to24_fromfunctions_results)
barplot!(ax1_4, tbl1_4.x, tbl1_4.value,
        stack = tbl1_4.grp,
        color = confplot_colors[tbl1_4.color])
```
...
#### Plot 4.1 - Predictions vs ground truth for 00 to 06 months
...
# Plot
y, yhat, train, test = regression_bestprediction(regression_currentCogScores_00to06_fromfunctions_results)
sc_train = scatter!(ax3_1, y[train], yhat[train]; color=:orange)
sc_test = scatter!(ax3_1, y[test], yhat[test]; color=:purple)
ablines!(ax3_1, 0, 1; color=:grey)
annotations!( ax3_1, ["r = $(round(cor(y, yhat); digits = 2))"], [Point(60, 110)], textsize = 20)
...
#### Plot 4.2 - Predictions vs ground truth for 06 to 12 months
...
# Plot
y, yhat, train, test = regression_bestprediction(regression_currentCogScores_06to12_fromfunctions_results)
sc_train = scatter!(ax3_2, y[train], yhat[train]; color=:orange)
sc_test = scatter!(ax3_2, y[test], yhat[test]; color=:purple)
ablines!(ax3_2, 0, 1; color=:grey)
annotations!( ax3_2, ["r = $(round(cor(y, yhat); digits = 2))"], [Point(60, 110)], textsize = 20)
...
#### Plot 4.3 - Predictions vs ground truth for 12 to 18 months
...
# Plot
y, yhat, train, test = regression_bestprediction(regression_currentCogScores_12to18_fromfunctions_results)
sc_train = scatter!(ax3_3, y[train], yhat[train]; color=:orange)
sc_test = scatter!(ax3_3, y[test], yhat[test]; color=:purple)
ablines!(ax3_3, 0, 1; color=:grey)
annotations!( ax3_3, ["r = $(round(cor(y, yhat); digits = 2))"], [Point(60, 98)], textsize = 20)
...
#### Plot 4.4 - Predictions vs ground truth for 18 to 24 months
...
# Plot
y, yhat, train, test = regression_bestprediction(regression_currentCogScores_18to24_fromfunctions_results)
sc_train = scatter!(ax3_4, y[train], yhat[train]; color=:orange)
sc_test = scatter!(ax3_4, y[test], yhat[test]; color=:purple)
ablines!(ax3_4, 0, 1; color=:grey)
annotations!( ax3_4, ["r = $(round(cor(y, yhat); digits = 2))"], [Point(50, 102)], textsize = 20)
