...
classification_currentCogScores_06to12mo_onlydemo = train_randomforest(
...
report_merits(classification_currentCogScores_06to12mo_onlydemo)

JLD2.@save "models/classification_currentCogScores_06to12mo_onlydemo.jld" classification_currentCogScores_06to12mo_onlydemo

## 2. Only taxonomic profiles

classification_currentCogScores_06to12mo_onlytaxa = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_06to12mo_onlytaxa)

JLD2.@save "models/classification_currentCogScores_06to12mo_onlytaxa.jld" classification_currentCogScores_06to12mo_onlytaxa

## 3. SES + taxonomic profiles

classification_currentCogScores_06to12mo_demoplustaxa = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_06to12mo_demoplustaxa)

JLD2.@save "models/classification_currentCogScores_06to12mo_demoplustaxa.jld" classification_currentCogScores_06to12mo_demoplustaxa

## 4. Only functional profiles

classification_currentCogScores_06to12mo_onlyecs = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_06to12mo_onlyecs)

JLD2.@save "models/classification_currentCogScores_06to12mo_onlyecs.jld" classification_currentCogScores_06to12mo_onlyecs

## 5. SES + functional profiles

classification_currentCogScores_06to12mo_demoplusecs = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_06to12mo_demoplusecs)

JLD2.@save "models/classification_currentCogScores_06to12mo_demoplusecs.jld" classification_currentCogScores_06to12mo_demoplusecs
...
classification_currentCogScores_12to18mo_onlydemo = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_12to18mo_onlydemo)

JLD2.@save "models/classification_currentCogScores_12to18mo_onlydemo.jld" classification_currentCogScores_12to18mo_onlydemo

## 7. Only taxonomic profiles

classification_currentCogScores_12to18mo_onlytaxa = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_12to18mo_onlytaxa)

JLD2.@save "models/classification_currentCogScores_12to18mo_onlytaxa.jld" classification_currentCogScores_12to18mo_onlytaxa

## 8. SES + taxonomic profiles

classification_currentCogScores_12to18mo_demoplustaxa = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_12to18mo_demoplustaxa)

JLD2.@save "models/classification_currentCogScores_12to18mo_demoplustaxa.jld" classification_currentCogScores_12to18mo_demoplustaxa

## 9. Only functional profiles

classification_currentCogScores_12to18mo_onlyecs = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_12to18mo_onlyecs)

JLD2.@save "models/classification_currentCogScores_12to18mo_onlyecs.jld" classification_currentCogScores_12to18mo_onlyecs

## 10. SES + taxonomic profiles

classification_currentCogScores_12to18mo_demoplusecs = train_randomforest(
    Resonance.Classification(),
...
report_merits(classification_currentCogScores_12to18mo_demoplusecs)

JLD2.@save "models/classification_currentCogScores_12to18mo_demoplusecs.jld" classification_currentCogScores_12to18mo_demoplusecs