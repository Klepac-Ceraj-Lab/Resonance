...
}\DIFaddend (Table 3, Figure 3A).  \DIFaddbegin \DIFadd{Subject age was consistently ranked highly in
...
\DIFadd{While LMs did not identify any taxa in }\DIFaddend the  \DIFaddbegin \DIFadd{0-6 month range
...
could predict }\textit{\DIFadd{future}} \DIFadd{cognitive performance measured (Figure 3B, D; Table 4).
...
in children older than }\DIFaddend 18  \DIFaddbegin \DIFadd{months were also important in
...
were dominated by two species of }\textit{\DIFadd{Klebsiella}}\DIFaddend ,
 \DIFaddbegin \textit{\DIFadd{K. pneumoniae}} \DIFadd{and }\textit{\DIFadd{K. varicola}} \DIFadd{(Figure 3D, E).
...
\begin{figure}[!h]
    ...
    \caption{
        \label{fig:1} \textbf{\DIFaddFL{The RESONANCE cohort is a diverse cohort with longitudinal sampling.}} \DIFaddFL{(}\textbf{\DIFaddFL{A}}\DIFaddFL{) Stool samples,
...
\begin{figure}[!htb]
    ...
    \caption{
        \textbf{\DIFaddFL{Microbial features can train RF models to predict MSEL subscores and brain volumes in children over 18 months of age}}\DIFaddFL{.
        (}\textbf{\DIFaddFL{A}}\DIFaddFL{) Test set correlations for RF models predicting MSEL subscale scores,
