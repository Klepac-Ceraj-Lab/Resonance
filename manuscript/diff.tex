...
\begin{abstract}
    ...
    Using a combination of  \DIFaddbegin \DIFadd{statistical }\DIFaddend and machine learning (ML) models,
    ...
    In addition, ML models were able to  predict the volume of brain regions  \DIFaddbegin \DIFadd{from microbial profiles,
