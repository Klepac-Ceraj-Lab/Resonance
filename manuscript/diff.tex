...
%DIF ADD main.tex         Fri Oct 20 10:16:49 2023
...
\begin{abstract}
    ...
    In addition, machine learning models were able to  predict the volume of brain regions  \DIFaddbegin \DIFadd{from microbial profiles,
...
\DIFaddbegin \subsection*{\DIFadd{Teaser}}
\DIFaddend 

%DIF <  The microorganisms that colonize the gut of humans can influence
%DIF <  health and disease in numerous
\DIFaddbegin \DIFadd{The complex community of microorganisms living in the guts of infants and children
...
and the WISC-V for children older than 6), but were normalized to a common scale ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 1B),
...
}\DIFaddend 3A-B,  \DIFaddbegin \DIFadd{table }\DIFaddend S1A-B);  \DIFaddbegin \DIFadd{Both analysis identified 
...
(table }\DIFaddend 3,  \DIFaddbegin \DIFadd{fig. 3A-B, E). Subject age was consistently ranked highly in
...
associated with cognitive function ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 2A-B). This kind of
...
\DIFaddbegin \printbibliography[heading=none]

\section*{\DIFadd{Acknowledgements}}
%DIF >  https://www.science.org/content/page/science-advances-information-authors#acknowledgments

\DIFadd{We thank Libusha Kelly (Albert Einstein School of Medicine) and Daphne Koinis Mitchell (Brown University)
...
\subsubsection*{\DIFadd{Data and materials availability}}

\DIFaddend All data needed to evaluate the conclusions in the paper
...
available on the  \DIFaddbegin \DIFadd{Data Dryad
\mbox{%DIFAUXCMD
...
download of input files are available on GitHub \DIFaddbegin \DIFadd{at https://github.com/KlepacCerajLab/Resonance,
and archived on Zenodo }\DIFaddend \cite{kevin_bonham_2023_7647510}.

 \DIFaddbegin \subsubsection*{\DIFadd{Funding}}
\DIFaddend This research was funded by NIH UG3 OD023313 and Wellcome LEAP 1kD.
\DIFaddbegin 

\subsubsection*{\DIFadd{Competing Interests}}
\DIFaddend The authors declare that they have no competing interests.

\DIFaddbegin \subsubsection*{\DIFadd{Author contributions}}
