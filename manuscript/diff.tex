...
%DIF DEL submission.tex   Fri Oct  6 11:44:27 2023
%DIF ADD main.tex         Fri Oct 20 18:24:06 2023
...
\author{%
    \parbox{\linewidth}{\centering
        ...
        Fatoumata Barry,$^{2}$
        Rosa Cano Lorente,$^{2}$
        The RESONANCE Consortium\DIFaddbegin \DIFadd{$^{\ast}$}\DIFaddend ,
        Curtis Huttenhower,$^{4}$
        Muriel Bruchhage,$^{3}$
        Viren D'Sa,$^{2}$
        Sean Deoni,$^{2}$
        Vanja Klepac-Ceraj\DIFdelbegin \DIFdel{$^{1\ast}$
    }\DIFdelend \DIFaddbegin \DIFadd{$^{1\dagger}$
    }\DIFaddend }
\\
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \normalsize{$^\ast$The RESONANCE consortium collaborators and affiliations are listed in the supplementary materials.}\\
\normalsize{$^\dagger$To whom correspondence should be addressed; E-mail:  vklepacc@wellesley.edu.}
\DIFaddend }
...
\begin{abstract}
     Emerging evidence implicates gut  \DIFaddbegin \DIFadd{microbial metabolism in neurodevelopmental disorders,
    but its influence }\DIFaddend on typical neurodevelopment has not been explored in detail.
    We investigated the relationship  \DIFaddbegin \DIFadd{between the microbiome and neuroanatomy and cognition of 381 }\DIFaddend healthy children,
    demonstrating that differences in  microbial taxa and  \DIFaddbegin \DIFadd{genes }\DIFaddend are associated
    with overall cognitive function and  the size of  brain regions.
    Using a combination of  \DIFaddbegin \DIFadd{statistical }\DIFaddend and machine learning  models,
    we showed that  \DIFaddbegin \DIFadd{species including }\textit{\DIFadd{Alistipes obesi}}\DIFadd{, }\textit{\DIFadd{Blautia wexlerae}}\DIFadd{, }\DIFaddend and  \DIFaddbegin \textit{\DIFadd{Ruminococcus gnavus}}
    \DIFadd{were enriched or depleted }\DIFaddend in children with  \DIFaddbegin \DIFadd{higher cognitive function scores.
    Microbial metabolism of }\DIFaddend short-chain fatty acids  \DIFaddbegin \DIFadd{was }\DIFaddend also associated with cognitive function.
    In addition,  \DIFaddbegin \DIFadd{machine }\DIFaddend models were able to  predict the volume of brain regions  \DIFaddbegin \DIFadd{from microbial profiles,
    and }\DIFaddend taxa that were  important in predicting cognitive function
     \DIFaddbegin \DIFadd{were also important for predicting }\DIFaddend individual brain regions  \DIFaddbegin \DIFadd{and specific subscales of cognitive function}\DIFaddend .
    These findings provide potential biomarkers of  \DIFaddbegin \DIFadd{neurocognitive }\DIFaddend development
    and may  \DIFaddbegin \DIFadd{enable }\DIFaddend development of targets for early detection and  intervention.
\end{abstract}

%DIF <  Teaser
%DIF <  This one-sentence summary provides a snapshot of your research for
%DIF <  non-specialist readers and will be used to promote your article if accepted for publication.
%DIF <  These should complement rather than repeat the title. 
\DIFaddbegin \subsubsection*{\DIFadd{Short title}}
\DIFaddend 

%DIF <  The microorganisms that colonize the gut of humans can influence
%DIF <  health and disease in numerous
\DIFaddbegin \DIFadd{Gut microbes are linked to child neurocognition
}\DIFaddend 

\DIFaddbegin \subsubsection*{\DIFadd{Teaser}}

\DIFadd{The complex community of microorganisms living in the guts of infants and children
may affect how their brains develop.
}
...
\subsubsection*{ \DIFaddbegin \DIFadd{The RESONANCE cohort is part of a study of child development}\DIFaddend }

We investigated the co-development of the brain and microbiome in
 \DIFaddbegin \DIFadd{381 }\DIFaddend healthy and neurotypically-developing children ( \DIFaddbegin \DIFadd{172 }\DIFaddend female) between  \DIFaddbegin \DIFadd{40 }\DIFaddend days and 10 years of age
( \DIFaddbegin \DIFadd{table }\DIFaddend 1,  \DIFaddbegin \DIFadd{fig. }\DIFaddend 1A,  \DIFaddbegin \DIFadd{fig. }\DIFaddend S1)
...
and the WISC-V for children older than 6), but were normalized to a common scale ( \DIFaddbegin \DIFadd{fig. 1D}\DIFaddend ),
As expected, the greatest differences in microbial taxa were observed across
child age ( \DIFaddbegin \DIFadd{fig. 1B, E; }\DIFaddend PCoA axis 1), with older children primarily
stratified into Bacteroidetes-dominant, Firmicutes-dominant, or
high-abundance \emph{Prevotella copri} ( \DIFaddbegin \DIFadd{fig. }\DIFaddend S2).
Overall subject-to-subject variation in gut microbial genes
and brain volume profiles was similarly driven largely by subject age ( \DIFaddbegin \DIFadd{fig. 1C, F}\DIFaddend ).
...
\cite{liuAlteredGutMicrobiota2019,wanUnderdevelopmentGutMicrobiota2021,magnussonRelationshipsDietrelatedChanges2015,mayneris-perxachsMicrobiotaAlterationsProline2022,needhamGutderivedMetaboliteAlters2022}}\hskip0pt%DIFAUXCMD
}\DIFaddend ,
...
in gut microbiomes in children over 18 months old ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 1G).
...
( \DIFaddbegin \DIFadd{fig. }\DIFaddend 1G, R\textsuperscript{2} =  \DIFaddbegin \DIFadd{0.0099}\DIFaddend , q \textless{}  \DIFaddbegin \DIFadd{0.01}\DIFaddend ),
as was variation in microbial gene functions (R\textsuperscript{2} =  \DIFaddbegin \DIFadd{0.0115}\DIFaddend , q \textless{} 0.001).
...
taxonomic diversity and broad lack of overlap between taxa in infants ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 1G).
As expected, age was significantly associated with microbial beta
diversity (taxa R\textsuperscript{2} =  \DIFaddbegin \DIFadd{0.0207}\DIFaddend , and  gene functions
annotated with UniRef90s clusters of 90\% similarity
\cite{suzekUniRefComprehensiveNonredundant2007} -
R\textsuperscript{2} =  \DIFaddbegin \DIFadd{0.0258}\DIFaddend , q \textless{} 0.001), and very strongly
associated with variation in neuroimaging \DIFaddbegin \DIFadd{(MRI) }\DIFaddend profiles (R\textsuperscript{2} =  \DIFaddbegin \DIFadd{0.258}\DIFaddend , q
\textless{} 0.001).
...
( \DIFaddbegin \DIFadd{fig. }\DIFaddend 1H, p \textless{} 0.001). Other functional
...
months, some variation ( \DIFaddbegin \DIFadd{taxa - 20.1}\DIFaddend \%, p \textless{} 0.01\DIFaddbegin \DIFadd{;
...
prevalence in a given age group ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 2A, N\textsubscript{species} =  \DIFaddbegin \DIFadd{116 }\DIFaddend for 0--120 months, 
N\textsubscript{species} =  \DIFaddbegin \DIFadd{54 }\DIFaddend for 0--6 months, N\textsubscript{species} =  \DIFaddbegin \DIFadd{136 }\DIFaddend for 18--120 months).
 \DIFaddbegin \DIFadd{No species were }\DIFaddend significantly associated (q  \DIFaddbegin \DIFadd{\textless{} 0.20}\DIFaddend ) with
...
several mirobial species were significantly enriched
 in children with higher cognitive function scores  \DIFaddbegin \DIFadd{(fig. 2B),
including }\DIFaddend \emph{ \DIFaddbegin \DIFadd{Alistipes obesi}\DIFaddend },
...
( \DIFaddbegin \DIFadd{fig. }\DIFaddend 2B). \textit{ \DIFaddbegin \DIFadd{Sutterella wadsworthensis}\DIFaddend } was the only microbial species
that was significantly negatively associated with cognitive function score (q value =  \DIFaddbegin \DIFadd{0.165}\DIFaddend ).
...
with a concurrent MSEL score (fig. 2C).
Several taxa associated with composite scores (fig. 2B)
...
and concurrent cognitive ability score ( \DIFaddbegin \DIFadd{table }\DIFaddend 2,  \DIFaddbegin \DIFadd{fig. 2D-F}\DIFaddend ) and found that
...
scores  \DIFaddbegin \DIFadd{in children under 6m (table }\DIFaddend 2; propionate degradation I,
 enrichment score (E.S.) =  \DIFaddbegin \DIFadd{-0.66}\DIFaddend , corrected p-value (q)
=  \DIFaddbegin \DIFadd{0.029), as were genes for synthesizing the 2 carbon SCFA acetate
(acetate synthesis II, }\DIFaddend E.S. =  \DIFaddbegin \DIFadd{-0.491}\DIFaddend , q =  \DIFaddbegin \DIFadd{0.059; acetate synthesis
III, }\DIFaddend E.S.  \DIFaddbegin \DIFadd{= -0.409}\DIFaddend , q =  \DIFaddbegin \DIFadd{0.133).
...
}\DIFaddend (acetate synthesis I, E.S. =  \DIFaddbegin \DIFadd{0.192}\DIFaddend , q =  \DIFaddbegin \DIFadd{0.145}\DIFaddend ;
acetate synthesis II, E.S. =  \DIFaddbegin \DIFadd{0.248}\DIFaddend , q =  \DIFaddbegin \DIFadd{0.15;
propionate degredation I}\DIFaddend , E.S. =  \DIFaddbegin \DIFadd{0.154}\DIFaddend , q =  \DIFaddbegin \DIFadd{0.178)}\DIFaddend ,
\DIFaddbegin \DIFadd{as was synthesis of the 4-carbon SCFA butyrate
(butyrate synthesis II, }\DIFaddend E.S. =  \DIFaddbegin \DIFadd{0.414}\DIFaddend , q =  \DIFaddbegin \DIFadd{0.178).
Synthesis }\DIFaddend of the amino  \DIFaddbegin \DIFadd{acid
glutamate was also }\DIFaddend significantly enriched in children with
higher cognitive function scores \DIFaddbegin \DIFadd{in this age group }\DIFaddend (glutamate synthesis  \DIFaddbegin \DIFadd{II}\DIFaddend , E.S. =  \DIFaddbegin \DIFadd{0.355}\DIFaddend , 
q =  \DIFaddbegin \DIFadd{0.023}\DIFaddend ). Taken together, these results suggest that
...
or in combination with microbial taxonomic profiles ( \DIFaddbegin \DIFadd{table }\DIFaddend 3).
 ...
 \begin{table}[!h]
    ...
    \end{tabular}
    \caption{\label{tab:rfbench} \DIFaddbeginFL \textbf{\DIFaddFL{RF models on microbial taxa and genes can learn associations with concurrently measured cognitive performance.}}
    \DIFaddendFL Benchmark metrics for the cognitive assessment score
...
performed poorly (mean test-set correlation  \DIFaddbegin \DIFadd{-0.13}\DIFaddend , mean RMSE  \DIFaddbegin \DIFadd{13.01}\DIFaddend ),
...
test-set correlation 0.429, mean RMSE  \DIFaddbegin \DIFadd{18.25).
Species }\DIFaddend that were important in RF overlapped with those that were
significant when testing the relationship with LMs ( \DIFaddbegin \DIFadd{fig.
3A, table S1); Both analysis identified 
...
Other }\DIFaddend taxa that were significant  \DIFaddbegin \DIFadd{in LMs were not identified by RF models
...
(table }\DIFaddend 3,  \DIFaddbegin \DIFadd{fig. 3B, E). Subject age was consistently ranked highly in
...
or that age itself is a useful predictor.
 ...
 \DIFaddbegin \subsubsection*{\DIFadd{Gut microbial profiles in the first year of life predict future cogntitive function}}

\DIFadd{While LMs did not identify any taxa in the 0-6 month range
that were associated with concurrently measured cognitive function}\DIFaddend ,
 \DIFaddbegin \DIFadd{we reasoned that developmental trajectories that begin
...
could predict }\textit{\DIFadd{future}} \DIFadd{cognitive performance measured at least 6 months
after the stool sample was collected (fig. 3C-D, F; table 4).
Models were consistently able to learn microbial species that are associated
with cognitive performance at a future visit
(mean time between visits: 21.5 months, S.D. }\DIFaddend =  \DIFaddbegin \DIFadd{9.9 months; fig. 3G,
...
\begin{table}[!h]
    ...
    \end{tabular}
    \caption{\label{tab:rfbench2}  \textbf{\DIFaddFL{RF models on microbial taxa and genes can learn associations with future cognitive performance.}}
    \DIFaddFL{Confidence intervals (C.I.) are calculated from the
    distribution of metrics from repeated CV at a confidence level of 95.
    Root mean square error (RMSE) was used to estimate how well the random forest model was able to predict the outcome.
    Demo. column indicates whether demographic factors such as maternal education, sex and age were included as predictors.}}
    \end{center}
...
models that predicted future cognitive function, if they were present (fig. 3B-C, table S5).
...
were dominated by two species of }\textit{\DIFadd{Klebsiella}}\DIFadd{,
}\textit{\DIFadd{K. pneumoniae}} \DIFadd{and }\textit{\DIFadd{K. varicola}} \DIFadd{(fig. 3C, F).
Many of the other species that ranked highest }\DIFaddend in  feature importance
\DIFaddbegin \DIFadd{were also oportunistic pathogens, or previously reported
to be linked with disease (eg. }\textit{\DIFadd{R. gnavus}}\DIFaddend ,  \DIFaddbegin \textit{\DIFadd{E. coli}}\DIFadd{).
}\DIFaddend 
...
of five probed subscales (fig. 4A, table 5), 
...
and the relative importances of several taxa (fig. 4B) is variable.
...
\DIFadd{stand out on models targeting visual reception (tables S2-4).
}
...
\begin{table}[!h]
    \begin{center}
        ...
        \end{tabular}
        \caption{\label{tab:subscalebenchmark}  \textbf{\DIFaddFL{RF models on microbial taxa and genes can learn associations with performance in cognitive subdomains.}}
        \DIFaddFL{Benchmark metrics for the Mullen subscales prediction models.
...
\DIFaddend \subsubsection*{Gut microbial taxonomic profiles predict brain structure differences}
 ...
 \DIFaddbegin \DIFadd{Given that individual microbes could be associated with particular domains
...
(children over 18 months old, N =  \DIFaddbegin \DIFadd{124}\DIFaddend ).
Some brain regions were more readily
predicted by RF models trained on microbial taxa ( \DIFaddbegin \DIFadd{tables 5, 6, and S6}\DIFaddend ), in particular those that were highly correlated with age.
These included the L/R lingual gyrus (mean RF correlations, Left =
 \DIFaddbegin \DIFadd{0.444}\DIFaddend , Right =  \DIFaddbegin \DIFadd{0.441}\DIFaddend ; importance for age, Left =  \DIFaddbegin \DIFadd{6.8}\DIFaddend \%, Right =
 \DIFaddbegin \DIFadd{7.7}\DIFaddend \%) and the L/R pericalcarine cortex (mean RF correlations, Left =
 \DIFaddbegin \DIFadd{0.267}\DIFaddend , Right =  \DIFaddbegin \DIFadd{0.315}\DIFaddend ; importance for age, Left = 3.6\%, Right =  \DIFaddbegin \DIFadd{6.2}\DIFaddend \%).
...
RF correlations =  \DIFaddbegin \DIFadd{0.275}\DIFaddend ; relative age importances =  \DIFaddbegin \DIFadd{1.1}\DIFaddend \%).
...
\begin{table}[!h]
    ...
    \begin{tabular}{|r|r|r|}
      ...
      Mean & 0.073 &  \DIFaddbeginFL \DIFaddFL{0.146 }\DIFaddendFL \\
      Standard deviation &  \DIFaddbeginFL \DIFaddFL{0.029 }\DIFaddendFL &  \DIFaddbeginFL \DIFaddFL{0.131 }\DIFaddendFL \\
      Maximum &  \DIFaddbeginFL \DIFaddFL{0.205 }\DIFaddendFL &  \DIFaddbeginFL \DIFaddFL{0.598 }\DIFaddendFL \\
      75th percentile &  \DIFaddbeginFL \DIFaddFL{0.081 }\DIFaddendFL &  \DIFaddbeginFL \DIFaddFL{0.212 }\DIFaddendFL \\
      50th percentile &  \DIFaddbeginFL \DIFaddFL{0.066 }\DIFaddendFL &  \DIFaddbeginFL \DIFaddFL{0.129 }\DIFaddendFL \\
      25th percentile & 0.057 &  \DIFaddbeginFL \DIFaddFL{0.073 }\DIFaddendFL \\
      Minimum &  \DIFaddbeginFL \DIFaddFL{0.036 }\DIFaddendFL &  \DIFaddbeginFL \DIFaddFL{-0.133 }\DIFaddendFL \\\hline
     \end{tabular}
    \caption{\label{tab:neuro}   \DIFaddbeginFL \textbf{\DIFaddFL{RF models on microbial taxa predicting brain regions have generally good performance.}}
    \DIFaddendFL Mean absolute proportional error (MAPE) and correlation coeficient (R)
    of test-set preditions are reported accross models for all brain regions.
    Complete list of values can be found on  \DIFaddbeginFL \DIFaddFL{table S6}\DIFaddendFL .}
    \end{center}
\end{table}
...
had a  \DIFaddbegin \DIFadd{negligible }\DIFaddend test-set correlation (R =  \DIFaddbegin \DIFadd{0.005)}\DIFaddend .
...
\emph{B. ovatus} ( \DIFaddbegin \DIFadd{3.2}\DIFaddend \% importance), and
\emph{B. uniformis} ( \DIFaddbegin \DIFadd{2.8}\DIFaddend \% importance).
...
In general, for all segments, a consistent number of species between  \DIFaddbegin \DIFadd{28 and 42 }\DIFaddend (median =  \DIFaddbegin \DIFadd{38}\DIFaddend , less than 30\% of the input features)
was responsible for half of the cumulative importance,
regardless of model performance ( \DIFaddbegin \DIFadd{fig. 4C-E, table }\DIFaddend S2).
...
included  \DIFaddbegin \DIFadd{nine }\DIFaddend species - 
\emph{Anaerostipes hadrus},
\emph{B. vulgatus},
\emph{ \DIFaddbegin \DIFadd{B. ovatus}\DIFaddend },
...
computed after fitness-weighting on the reported brain segments ( \DIFaddbegin \DIFadd{fig. 4D-E}\DIFaddend ).
...
}\DIFaddend (mean =  \DIFaddbegin \DIFadd{1.4}\DIFaddend \%; min =  \DIFaddbegin \DIFadd{0.8}\DIFaddend \%; max =  \DIFaddbegin \DIFadd{3.6\%, fig. 4D-E}\DIFaddend ).
\emph{B. wexlerae}, which was important in RF models of cognitive function, 
 \DIFaddbegin \DIFadd{was }\DIFaddend also important in models of the entorhinal, fusiform and lingual areas
...
but also \emph{Alistipes finegoldii and  \DIFaddbegin \DIFadd{S. salivarius}\DIFaddend }.

 \emph{A. celatus},  \DIFaddbegin \DIFadd{an }\DIFaddend equol-producing species,  \DIFaddbegin \DIFadd{is an }\DIFaddend examples of the second contribution
pattern, where a taxon only contributes significantly to a very small number of segments. 
 \DIFaddbegin \DIFadd{This species was }\DIFaddend highly important in predicting the relative volume of
the right anterior cingulate ( \DIFaddbegin \DIFadd{2.8\% relative importance}\DIFaddend ).
Another example of this pattern is \emph{ \DIFaddbegin \DIFadd{Coprococcus eutactus}}
\DIFadd{which }\DIFaddend is heavily associated with the left  \DIFaddbegin \DIFadd{precentral area (3.5}\DIFaddend \% importance). 
...
is the highest for a microbe in RF models ( \DIFaddbegin \DIFadd{3.7}\DIFaddend \% importance);
...
Left =  \DIFaddbegin \DIFadd{1.9}\DIFaddend \%, Right =  \DIFaddbegin \DIFadd{2.5}\DIFaddend \%), along with upper regions like the left
precentral ( \DIFaddbegin \DIFadd{2.0}\DIFaddend \% importance) and paracentral lobes (importances, Left =  \DIFaddbegin \DIFadd{2.0}\DIFaddend \%, Right =  \DIFaddbegin \DIFadd{1.5}\DIFaddend \%).
...
This is particularly intriguing, since  \emph{A. celatus}
 \DIFaddbegin \DIFadd{was }\DIFaddend also the most important features in RF models of the
...
\DIFaddbegin \DIFadd{Another Eggerthelaceae, }\DIFaddend \emph{ \DIFaddbegin \DIFadd{Gordonibacter }\DIFaddend pamelaeae}\DIFaddbegin \DIFadd{,
...
between early-life microbiomes and future cognitive function scores (fig. 3).
...
associated with cognitive function ( \DIFaddbegin \DIFadd{fig. 3C, F}\DIFaddend ). This kind of
...
are associated with cognitive function scores ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 2). 
...
( \DIFaddbegin \DIFadd{fig. }\DIFaddend S3).
...
Although we  \DIFaddbegin \DIFadd{did not directly test the causal relationships
...
this study provides clear and statistically significant associations
 \DIFaddbegin \DIFadd{that could serve as targets for future efforts in pre-clinical models.
...
review board at Rhode Island Hospital, 
 \DIFaddbegin \DIFadd{(Investigating Early Childhood Neurodevelopment 1500991,
...
As a study of neurotypical development, mothers and their children
 \DIFaddbegin \DIFadd{exclusion criteria included }\DIFaddend major risk factors for abnormal or atypical development \DIFaddbegin \DIFadd{,
i.e., }\DIFaddend preterm birth (\textless 37 weeks gestation) low birth weight (\textless 1500g),
 \DIFaddbegin \textit{\DIFadd{in utero}} \DIFaddend exposure to alcohol, cigarette or illicit substance exposure;
...
For this study,  \DIFaddbegin \DIFadd{381 }\DIFaddend typically-developing children between the
ages of  \DIFaddbegin \DIFadd{40 days }\DIFaddend and 10 years  (median age 2 years, 2 months) were
...
First, KneadData (v0 \DIFaddbegin \DIFadd{.10.0}\DIFaddend ) was used to perform quality
control of raw sequence reads, such as read trimming and removal of
reads matching a human genome reference. Next, MetaPhlAn (v3\DIFaddbegin \DIFadd{.1}\DIFaddend .0 , using
database mpa\_ \DIFaddbegin \DIFadd{v31}\DIFaddend \_CHOCOPhlAn\_201901) was used to generate taxonomic
profiles by aligning reads to a reference database of marker genes.
Finally, HUMAnN (v3\DIFaddbegin \DIFadd{.6}\DIFaddend .0 ) was used to functionally profile the
metagenomes.
...
(for the experiments in fig. 3) or, when available, subscores on the
Mullen Scales of Early Learning (fig. 4 A-B: expressive language, gross motor and visual reception).
...
}\DIFaddend Age (in months) was provided as a covariate for all models ( \DIFaddbegin \DIFadd{table }\DIFaddend S3).
...
datasets  \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{woodruffChronicInflammationNeutrophil2023a}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
...
\DIFadd{This research was funded by NIH UG3 OD023313 and Wellcome LEAP 1kD.
}


\section*{\DIFadd{Author contributions}}
\DIFaddend % https://credit.niso.org/

\DIFaddbegin \begin{itemize}[noitemsep]
    \item \DIFadd{Conceptualization: }\DIFaddend KSB, VKC, CH, and SD
     \DIFaddbegin \item \DIFadd{Methodology: KSB, VKC, CH, and }\DIFaddend SD
     \DIFaddbegin \item \DIFadd{Project administraion: KSB, VKC, CH, and SD
    }\item \DIFadd{Funding acquisition: VKC, SD, and VD
    }\item \DIFadd{Data curation: KSB, GFB, }\DIFaddend SHM, MB, FB, RCL, and JB
     \DIFaddbegin \item \DIFadd{Formal analyses: }\DIFaddend KSB, GFB, and MB
     \DIFaddbegin \item \DIFadd{Investigation: }\DIFaddend KSB, GFB, SHM, EW, FB, RCL, and MB
     \DIFaddbegin \item \DIFadd{Resources: }\DIFaddend SHM, EW, FB, RCL, JB, CH, and MB
     \DIFaddbegin \item \DIFaddend Software and data visualizations \DIFaddbegin \DIFadd{: }\DIFaddend KSB and GFB
     \DIFaddbegin \item \DIFadd{Supervision: }\DIFaddend KSB, MB, SD, VD, and VKC 
     \DIFaddbegin \item \DIFadd{Validation: }\DIFaddend KSB, SHM, JB, and MB
     \DIFaddbegin \item \DIFadd{Initial draft: }\DIFaddend KSB and GFB
     \DIFaddbegin \item \DIFadd{Revision and editing: KSB, GFB, }\DIFaddend SD, CH, and VKC
 \DIFaddbegin \end{itemize}


\section*{\DIFadd{Competing Interests}}
\DIFadd{The authors declare that they have no competing interests.
}\section*{\DIFadd{Figures}}

\section*{\DIFadd{Data and materials availability}}

\DIFadd{All data needed to evaluate the conclusions in the paper
...
available on the Data Dryad
\mbox{%DIFAUXCMD
\cite{bonhamDataDryad2023}}\hskip0pt%DIFAUXCMD
.
...
\mbox{%DIFAUXCMD
\cite{bezansonJuliaFreshApproach2017,bonhamMicrobiomeJlBiobakeryUtils2021,danischMakieJlFlexible2021,blaomMLJJuliaPackage2020,ben_sadeghi_2022_7359268,dahua_lin_2023_7695673,douglas_bates_2023_7734970}}\hskip0pt%DIFAUXCMD
.
...
download of input files are available on GitHub at https://github.com/KlepacCerajLab/Resonance,
and archived on Zenodo \mbox{%DIFAUXCMD
\cite{kevin_bonham_2023_7647510}}\hskip0pt%DIFAUXCMD
.
}
...
\begin{figure}[!h]
    \centering
    \small
    %DIF >  \includegraphics[width=0.9\textwidth]{assets/Figure1.png}
    \caption{
        \label{fig:1} \textbf{\DIFaddFL{The RESONANCE cohort is a diverse cohort with accelerated longitudinal sampling.}} \DIFaddFL{(}\textbf{\DIFaddFL{A}}\DIFaddFL{) Stool samples,
        ...
        (}\textbf{\DIFaddFL{B}}\DIFaddFL{) Cognitive function scores are assessed by
        different instruments, but may be normalized using full-scale composite scores.
        (}\textbf{\DIFaddFL{C-D}}\DIFaddFL{) Principal coordinates analysis using Bray-Curtis dissimilarity on
        ...
        Differences in gene function profiles (}\textbf{\DIFaddFL{E}}\DIFaddFL{) and neuroimaging (PCA based on
        the Euclidean distance of brain region volumes) (}\textbf{\DIFaddFL{F}}\DIFaddFL{) are likewise
        dominated by changes as children age. (}\textbf{\DIFaddFL{G}}\DIFaddFL{) Permutation analysis of
        ...
        in children over 18 months of age. (}\textbf{\DIFaddFL{H}}\DIFaddFL{) Mantel testing of different
...
\begin{figure}[!htb]
    \centering
    \small
    %DIF >  \includegraphics[width=0.9\textwidth]{assets/Figure2.png}
    \caption{
        \textbf{\DIFaddFL{Taxa and gene functional groups are associated with cognitive function.}}
        \DIFaddFL{(}\textbf{\DIFaddFL{A}}\DIFaddFL{) Volcano plot of multivariable linear model results showing the
        ...
        \textless{} 0.2) are colored red. (}\textbf{\DIFaddFL{B}}\DIFaddFL{) For taxa that were significantly
        associated with cognitive function,
        heatmaps of correlation with cognitive function in different age groups.
        (}\textbf{\DIFaddFL{C}}\DIFaddFL{) Multivariate linear models showing the relationship
        ...
        (}\textbf{\DIFaddFL{D-E}}\DIFaddFL{) Enrichment plots for proprionate degradation I gene set
        used in feature set enrichment analysis (FSEA) in children under 6m (D)
        or over 18m (E). (}\textbf{\DIFaddFL{G}}\DIFaddFL{) summary of FSEA
...
\begin{figure}[!htb]
    \centering
    \small
    %DIF >  \includegraphics[width=0.9\textwidth]{assets/Figure3.png}
    \caption{
        \textbf{\DIFaddFL{Random forest models predict both concurrent and future measured cognitive function.}}
        \DIFaddFL{Comparison of RF predictor importance versus linear models for children
        over 18 months (}\textbf{\DIFaddFL{A}}\DIFaddFL{).
        ...
        Distribution of ages for each microbiome sampling - cognitive assesment dyad (}\textbf{\DIFaddFL{C}}\DIFaddFL{).
        ...
        both concurrent (}\textbf{\DIFaddFL{D}}\DIFaddFL{) and future (}\textbf{\DIFaddFL{E}}\DIFaddFL{)
        ...
        for RF models both for concurrent (}\textbf{\DIFaddFL{F}}\DIFaddFL{) and future (}\textbf{\DIFaddFL{G}}\DIFaddFL{) assesment prediction.
        }}
    \label{fig:3}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \small
    %DIF >  \includegraphics[width=0.9\textwidth]{assets/Figure4.png}
    \caption{
        \textbf{\DIFaddFL{Coupled importance of microbes in neuroanatomy and subscores are consistent with known subcortical associations with cognition.}}
        \DIFaddFL{(}\textbf{\DIFaddFL{A}}\DIFaddFL{) Test set correlations for RF models predicting MSEL subscale scores,
        with or without demographics included as predictors.
        (}\textbf{\DIFaddFL{B}}\DIFaddFL{) Important taxa in models predicting MSEL subscale scores.
        (}\textbf{\DIFaddFL{C}}\DIFaddFL{) Average test-set correlations for prediction of MRI segmentation
        data from microbiome and demographics on select segments after repeated
        cross validation. (}\textbf{\DIFaddFL{D}}\DIFaddFL{) Heatmap of average individual relative taxa
        ...
        and their respective highest-load segments (}\textbf{\DIFaddFL{E}}\DIFaddFL{).
    }}
    \label{fig:4}
\end{figure}
\DIFaddend 
