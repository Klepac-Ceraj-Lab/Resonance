...
and the WISC-V for children older than 6), but were normalized to a common scale ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 1D),
...
}\DIFaddend 3A,  \DIFaddbegin \DIFadd{table }\DIFaddend S1);  \DIFaddbegin \DIFadd{Both analysis identified 
...
associated with cognitive function ( \DIFaddbegin \DIFadd{fig. }\DIFaddend 3C, F). This kind of
