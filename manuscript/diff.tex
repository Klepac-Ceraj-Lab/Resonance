...
%DIF ADD main.tex         Thu Oct 19 13:39:56 2023
...
and cognitive function of  \DIFaddbegin \DIFadd{381 }\DIFaddend healthy children, demonstrating that
...
including \emph{ \DIFaddbegin \DIFadd{Alistipes obesi}\DIFaddend } and \emph{Blautia wexlerae}, were
...
in both the left and right hemispheres
 \DIFaddbegin \DIFadd{and was among the top predictors of gross motor and expressive language performance.
...
\DIFaddbegin \DIFadd{The complex community of microorganisms living in the gastrointestinal tract of infants and children
...
child age (Figure  \DIFaddbegin \DIFadd{1B, E; }\DIFaddend PCoA axis 1), with older children primarily
...
and brain volume profiles was similarly driven largely by subject age (Figure  \DIFaddbegin \DIFadd{1C, F}\DIFaddend ).
...
(Figure 1G, R\textsuperscript{2} =  \DIFaddbegin \DIFadd{0.0099}\DIFaddend , q \textless{}  \DIFaddbegin \DIFadd{0.01}\DIFaddend ),
...
prevalence in a given age group (Figure 2A, N\textsubscript{species} =  \DIFaddbegin \DIFadd{116 }\DIFaddend for 0--120 months, 
...
several mirobial species were significantly enriched
 in children with higher cognitive function scores  \DIFaddbegin \DIFadd{(Figure 2B),
...
(Figure 2B). \textit{ \DIFaddbegin \DIFadd{Sutterella wadsworthensis}\DIFaddend } was the only microbial species
...
and concurrent cognitive ability score (Table 2, Figure  \DIFaddbegin \DIFadd{2D-F}\DIFaddend ) and found that
...
scores  \DIFaddbegin \DIFadd{in children under 6m }\DIFaddend (Table 2; propionate degradation I,
...
3A-B, Table S1A-B);  \DIFaddbegin \DIFadd{Both analysis identified 
...
}\DIFaddend (Table 3, Figure  \DIFaddbegin \DIFadd{3A-B, E). Subject age was consistently ranked highly in
...
after the stool sample was collected (Figure 3C-D, F; Table 4).
Models were consistently able to learn microbial species that are associated
with cognitive performance at a future visit
(mean time between visits: 21.5 months, S.D. }\DIFaddend =  \DIFaddbegin \DIFadd{9.9 months; Figure 3G,
...
models that predicted future cognitive function, if they were present (Figure 3B-C, Table S5).
...
}\textit{\DIFadd{K. pneumoniae}} \DIFadd{and }\textit{\DIFadd{K. varicola}} \DIFadd{(Figure 3C, F).
...
\begin{table}[!h]
    ...
    Complete list of values can be found on Table  \DIFaddbeginFL \DIFaddFL{S6}\DIFaddendFL .}
    \end{center}
\end{table}
...
regardless of model performance (Figure  \DIFaddbegin \DIFadd{4C-E}\DIFaddend , Table S2).
...
computed after fitness-weighting on the reported brain segments (Figure  \DIFaddbegin \DIFadd{4D-E}\DIFaddend ).
...
}\DIFaddend (mean =  \DIFaddbegin \DIFadd{1.4}\DIFaddend \%; min =  \DIFaddbegin \DIFadd{0.8}\DIFaddend \%; max =  \DIFaddbegin \DIFadd{3.6}\DIFaddend \%, Figure  \DIFaddbegin \DIFadd{4D-E}\DIFaddend ).
...
}\DIFaddend Age (in months) was provided as a covariate for all models (Table S3).
