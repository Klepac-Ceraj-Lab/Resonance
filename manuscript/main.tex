...
\begin{sidewaysfigure}[!htb]
    ...
    \caption{
        ...
        for RF models both for concurrent (\textbf{E}) and future (\textbf{G}) assesment prediction.
        }
    \label{fig:3}
\end{sidewaysfigure}
...
\textit{F. prausnitzii}, % check if we've mentioned these before, or use the full name
\textit{E. eligens}, 
\textit{P. excrementihominis}, and
\textit{Alistipes obesi} as important
...
(mean time between visits: XX, %TODO
mean test set correlation: YY).
...
\textit{K. pneumoniae} and \textit{K. varicola} (Figure 3C).
