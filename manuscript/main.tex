...
The complex community of microorganisms living in the gastrointestinal tract of infants and children
...
child age (Figure 1B, E; PCoA axis 1), with older children primarily
...
and brain volume profiles was similarly driven largely by subject age (Figure 1C, F).
...
(Table 3, Figure 3A-B, E). Subject age was consistently ranked highly in
...
(mean time between visits: 21.5 months, S.D. = 9.9 months; Figure 3G,
...
\textit{K. pneumoniae} and \textit{K. varicola} (Figure 3C, F).
