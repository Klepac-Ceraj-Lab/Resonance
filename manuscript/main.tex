...
\subsection*{Gut microbial profiles in the first year of life predict future cogntitive function}
...
namely Expressive Language (EL; test-set RMSE \hl{XXX}, test-set correlation \hl{YYYY}), 
Gross Motor (GM; test-set RMSE \hl{XXX}, test-set correlation \hl{YYYY}) and 
Visual Reception (VR; test-set RMSE \hl{XXX}, test-set correlation \hl{YYYY}).
