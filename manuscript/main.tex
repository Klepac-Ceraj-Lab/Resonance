...
\textit{Alistipes obesi} as important % A. obesi was mentioned before, ~ lines 120, 390
...
\subsubsection*{Gut microbial taxa relate diffrentially to distinct cognitive subscales} %TODO: add numbers!

Is it possible to associate the predictive species with different components of cognition? 
After probing the aforedescribed importances of potential of taxa and ECs 
towards composite cognitive scores, we proceeded to verify if and how this relationship 
would hold for different subcomponents of the cognitive function assessment. 
We collected those in the form of the 
Mullen Scales of Early Learning (MSEL - see \textit{see Methods}). 
Taxonomic profiles coupled with demographics exhibited predictive potential towards three probed subscales, 
...
but also the relative importances of several taxa.
...
\textit{R. faecis}, \textit{S. salivarius} and \textit{F. saccharivorans} are
...
(for the experiments in Figure \textbf{3}) or, when available, segregate scores on the
