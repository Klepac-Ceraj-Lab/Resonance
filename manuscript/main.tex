...
responsible for 80\% of the total fitness-weighted relative importance in RF models
(Table 3, Figure 3A).
...
0.421, Right = 0.434; relative weighted importance for age, Left = 7.5\%, Right =
8.3\%) and the L/R pericalcarine cortex (mean RF correlations, Left =
0.200, Right = 0.273; relative weighted importance for age, Left = 3.6\%, Right = 6.3\%).
...
by three species of \emph{Bacteroides}: \emph{B. vulgatus} (3.3\%
relative weighted importance), \emph{B. ovatus} (3.7\% relative weighted importance), and
\emph{B. uniformis} (2.9\% relative weighted importance).
...
was responsible for half of the fitness-weighted cumulative importance,
...
\emph{Blautia wexlerae} - that combined, account for approximately 10\% of the cumulative relative importances,
...
Among these, \emph{Anaerostipes hadrus} is the variable with 
...
the right anterior cingulate (respectively, 3.0\% and 2.6\% relative weighted
...
It is heavily associated with the left pars opercularis (2.7\% relative weighted importance). 
...
is the highest for a microbe in RF models (4.0\% relative weighted importance);
...
posterior cingulate such as the pars opercularis (relative weighted importances,
Left = 2.3\%, Right = 2.8\%), along with upper regions like the left
precentral (2.3\% relative weighted importance) and paracentral lobes (relative weighted
importances, Left = 2.6\%, Right = 1.9\%).
