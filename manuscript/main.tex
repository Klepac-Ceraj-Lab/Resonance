...
\begin{figure}[!htb]
    ...
    \caption{
        ...
        (\textbf{A}) Comparison of RF predictor importance versus linear models for children
        over 18 months.
        ...
        both concurrent (\textbf{B}) and future (\textbf{C})
        ...
        (\textbf{D}) Comparison of RF predictor importance for microbial features
        ...
        for RF models both for concurrent (\textbf{E}) and future (\textbf{F}) assesment prediction.
        (\textbf{G}) Distribution of ages for each microbiome sampling - cognitive assesment dyad
        at sampling age (left),
        or asessment age (right).
