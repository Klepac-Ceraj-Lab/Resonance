...
associations between the thalamus and the EL component of the Mullen scales.
...
the central opercular cortex (COC) and Gross Motor development. In this case, we identified that
...
and the Visual Reception score.
