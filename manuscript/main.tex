...
and the WISC-V for children older than 6), but were normalized to a common scale (fig. 1B),
...
(table 3, fig. 3A-B, E). Subject age was consistently ranked highly in
...
associated with cognitive function (fig. 2A-B). This kind of
