...
\begin{figure}[!h]
    ...
    \caption{
        \label{fig:1} \textbf{The RESONANCE cohort is a diverse cohort with longitudinal sampling.} (\textbf{A}) Stool samples,
...
\begin{figure}[!htb]
    ...
    \caption{
        \textbf{Microbial features can train RF models to predict MSEL subscores and brain volumes in children over 18 months of age}.
