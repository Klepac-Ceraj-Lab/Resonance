...
the right anterior cingulate (\hl{2.8\%} relative importance).
Another example of this pattern is \emph{Coprococcus eutactus}
which is heavily associated with the left precentral area (\hl{3.5\%} importance). 
...
is the highest for a microbe in RF models (\hl{3.7\%} importance);
...
\hl{Left = 1.9\%, Right = 2.5\%}), along with upper regions like the left
precentral (2.0\% importance) and paracentral lobes (importances, \hl{Left = 2.0\%, Right = 1.5\%}).
