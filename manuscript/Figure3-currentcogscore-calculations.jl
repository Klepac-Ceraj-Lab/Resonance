...
open(scratchfiles("currentcomposite_longnames.txt"), "w") do io
    for i in oldnames
        println(io, i)
    end
end
open(scratchfiles("currentcomposite_hashnames.txt"), "w") do io
    for i in newnames
        println(io, i)
    end
end
...
filtered_mdata_ecs_df_00to06 = filter_prevalences(
    dropmissing(mdata_ecs_df[mdata_ecs_df.filter_00to06, :], Not(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"])),
    :cogScore,
    [:subject, :timepoint, :sex, :education, :ageMonths],
    Symbol.(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"]);
...
filtered_mdata_taxa_df_18to120 = filter_prevalences(
    dropmissing(mdata_taxa_df[mdata_taxa_df.filter_18to120, :], Not(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"])),
    :cogScore,
    [:subject, :timepoint, :sex, :education, :ageMonths],
    Symbol.(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"]);
    lbound = taxa_prevalence_threshold_lower,
...
filtered_mdata_ecs_df_18to120 = filter_prevalences(
    dropmissing(mdata_ecs_df[mdata_ecs_df.filter_18to120, :], Not(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"])),
    :cogScore,
    [:subject, :timepoint, :sex, :education, :ageMonths],
    Symbol.(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"]);
    lbound = ecs_prevalence_threshold_lower,
...
filtered_mdata_taxa_df_00to120 = filter_prevalences(
    dropmissing(mdata_taxa_df[mdata_taxa_df.filter_00to120, :], Not(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"])),
    :cogScore,
    [:subject, :timepoint, :sex, :education, :ageMonths],
    Symbol.(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"]);
    lbound = taxa_prevalence_threshold_lower,
...
filtered_mdata_ecs_df_00to120 = filter_prevalences(
    dropmissing(mdata_ecs_df[mdata_ecs_df.filter_00to120, :], Not(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"])),
    :cogScore,
    [:subject, :timepoint, :sex, :education, :ageMonths],
    Symbol.(["sample", "read_depth", "edfloat", "race", "filter_00to120", "filter_00to06", "filter_18to120", "filter_future_omni", "filter_future_cog", "omni", "Mullen::mullen_ExpressivelanguageT", "Mullen::mullen_FineMotorT", "Mullen::mullen_GrossMotorT", "Mullen::mullen_ReceptiveLanguageT", "Mullen::mullen_VisualReceptionT"]);
    lbound = ecs_prevalence_threshold_lower,
...
CSV.write(tablefiles("figure3", "00to120_ecs.csv"), filtered_mdata_ecs_df_00to120)
...
## 6. Only SES
regression_currentCogScores_00to120mo_onlydemo = probe_prod_randomforest(
    Resonance.Regression(),
...
## 7. Only taxonomic profiles
regression_currentCogScores_00to120mo_onlytaxa = probe_prod_randomforest(
    Resonance.Regression(),
...
## 8. SES + taxonomic profiles
regression_currentCogScores_00to120mo_demoplustaxa = probe_prod_randomforest(
    Resonance.Regression(),
...
## 9. Only functional profiles
regression_currentCogScores_00to120mo_onlyecs = probe_prod_randomforest(
    Resonance.Regression(),
...
## 10. SES + functional profiles
regression_currentCogScores_00to120mo_demoplusecs = probe_prod_randomforest(
    Resonance.Regression(),
...
jldsave(modelfiles("regression_currentCogScores_00to120mo_demoplusecs.jld"); regression_currentCogScores_00to120mo_demoplusecs)